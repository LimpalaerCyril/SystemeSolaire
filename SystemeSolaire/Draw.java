...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private void init() {
        ...
        frame = new JFrame();
        offscreenImage = new BufferedImage(5*width, 5*height, BufferedImage.TYPE_INT_ARGB);
        onscreenImage  = new BufferedImage(5*width, 5*height, BufferedImage.TYPE_INT_ARGB);
        offscreen = offscreenImage.createGraphics();
        onscreen  = onscreenImage.createGraphics();
        offscreen.scale(5.0, 5.0);  // since we made it 2x as big
